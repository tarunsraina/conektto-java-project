...
This application is configured for Service Discovery and Configuration with . On launch, it will refuse to start if it is not 
## Development
...
To build the final jar and optimize the P7 application for production, run:
